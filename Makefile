...
.PHONY: validate verify-artifacts test test-control-plane test-release-gate test-release-evidence test-branch-cleanup test-iso-change-filter test-repository-settings test-install-vm release-policy sync-repo-metadata apply-repo-settings iso smoke install-smoke clean run tree
